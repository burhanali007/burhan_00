...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update BurhanAli Tool')
...
def mb():
	...
	if bm =='':
	    ...
	    psb('WellCome To BurhanAli')
	    psb('Congratulations BurhanAli Tool Has Been Updated Successfully')
